        ...
        <>
            <section className="max-w-6xl mx-auto px-6 pb-16">
                ...
                <p className="text-gray-700 mb-4">
                    A SalvTec é uma empresa especializada em soluções de climatização para residências, comércios e indústrias. Com anos de experiência no mercado, oferecemos serviços de alta qualidade que garantem conforto e eficiência energética.
                </p>
                <p className="text-gray-700 mb-4">
